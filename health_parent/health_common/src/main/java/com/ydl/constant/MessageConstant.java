...
public class MessageConstant {
    ...
    public static final String UPDATE_SETMEAL_SUCCESS = "修改套餐信息成功";
    public static final String UPDATE_SETMEAL_FAIL = "修改套餐信息失败";
    ...
    public static final String GET_ROLE_USER_SUCCESS = "查询用户成功";
    public static final String ORDER_CANCLE = "预约成功";

    /**
     * 预约成功，信息回显
     */
    public static final String ORDER_ECHO_SUCCESS = "预约信息显示成功";
    public static final String ORDER_ECHO_FAIL = "预约信息显示成功";

    public static final String QUERY_ORDER_LIST_SUCCESS = "预约列表显示成功";
    public static final String QUERY_ORDER_LIST_FAIL = "预约列表显示成功";
}